...
def entropy(symb2freq):
    total = sum(symb2freq.values()) 
    return sum(freq / total * log2(total / freq) for freq in symb2freq.values())
...
for file in os.listdir(infolder):
    ...
    with open(outfilename, 'w', newline='') as out:
        ...
        fieldnames = (corpus, "lang", "s", "w", "rw", "t", "rt", "huff", "rhuff", "ent", "rent", "ipw", "ripw")
        ...
        with gzip.open(fname,'r') as f:        
            ...
            # 1. Measures from the dictionary - entropy, huffsize, ipw
            
            t1 = len(symb2freq1)
            huff1 = huff(symb2freq1)

            # 2. Measures from the dictionary - entropy, huffsize, ipw
            t2 = len(symb2freq2)
